function compareTransImpToFilterOxy
%%compareTransImpToFilterOxy
%
% 2018-12-12
...
%% -- UI --------------------------------------------------------------- %%
filename_and_path{1} = '..\Measurements\rawData_oxySensor\20181214_Ired_Gunnar_part1.csv';
filename_and_path{2} = '..\Measurements\rawData_oxySensor\20181214_Ired_Gunnar_part2.csv';
figTitle = 'Oxymeter Sensor Infrarot Gunnar';
gain = -15;

% filename_and_path{1} = '..\Measurements\rawData_oxySensor\20181214_red_Gunnar_part1.csv';
% filename_and_path{2} = '..\Measurements\rawData_oxySensor\20181214_red_Gunnar_part2.csv';
% figTitle = 'Oxymeter Sensor rot Gunnar';
% gain = -28;

% filename_and_path{1} = '..\Measurements\rawData_oxySensor\20181214_Ired_Krista_part1.csv';
% filename_and_path{2} = '..\Measurements\rawData_oxySensor\20181214_Ired_Krista_part2.csv';
% figTitle = 'Oxymeter Sensor Infrarot Krista';
% gain = -15;

% filename_and_path{1} = '..\Measurements\rawData_oxySensor\20181214_red_Krista_part1.csv';
% filename_and_path{2} = '..\Measurements\rawData_oxySensor\20181214_red_Krista_part2.csv';
% figTitle = 'Oxymeter Sensor rot Krista';
% gain = -28;
